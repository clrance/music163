...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_headerNav_headerNav__ = __webpack_require__(188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_headerNav_headerNav___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_headerNav_headerNav__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vux_src_components_tab_tab_vue__ = __webpack_require__(163);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vux_src_components_tab_tab_item_vue__ = __webpack_require__(162);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'searchList',
  components: {
    headerNav: __WEBPACK_IMPORTED_MODULE_0__components_headerNav_headerNav___default.a,
  ...
  methods: {
    chooseHotSearch: function chooseHotSearch(val) {
      this.searchVal = val;
      this.goSearch();
    },
    goSearch: function goSearch() {
    ...
    switchSearchType: function switchSearchType(index) {
      if (index == 0) {
        this.searchType = 1;
      } else if (index == 1) {
        this.searchType = 100;
    ...
    compDistance: function compDistance(event) {
      ...
      var TypeBox = [1, 100, 10, 1000, 1002];
      if (offsetNum > 80) {
...
// module
exports.push([module.i, ".backgroundRed{background-color:#f33}.mx_flex{display:-webkit-box;display:-webkit-flex;display:flex}.mx_flex_content{-moz-flex-direction:row;-o-flex-direction:row;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;flex-direction:row;-o-flex-wrap:wrap;-webkit-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-pack:justify;-webkit-justify-content:space-between;justify-content:space-between}.mx_flex_mid{display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;justify-content:center;-webkit-box-align:center;-webkit-align-items:center;align-items:center}.mx_brbox{box-sizing:border-box}.mx_more_ellipsis{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}.mx_more_ellipsis,.mx_single_ellipsis{overflow:hidden;text-overflow:ellipsis}.mx_single_ellipsis{white-space:nowrap}.halfBorder{position:relative}.halfBorder:after{content:\"  \";position:absolute;left:0;top:0;width:200%;height:200%;border-bottom:1px solid #dedede;-webkit-transform-origin:0 0;transform-origin:0 0;-webkit-transform:scale(.5);transform:scale(.5);box-sizing:border-box}#searchList{width:100%;height:100%}#searchList .search{position:relative;width:100%;height:.48rem;line-height:.48rem;background-color:#f33;text-align:center;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;justify-content:center;-webkit-box-align:center;-webkit-align-items:center;align-items:center}#searchList .search .icon-micro{font-size:.22rem;color:#fff;position:absolute;top:0;left:5%}#searchList .search .icon-music{font-size:.22rem;color:#fff;position:absolute;top:.03rem;left:90%}#searchList .search .cancelSearch{font-size:.14rem;color:#fff;position:absolute;top:0;left:90%}#searchList .search .search-box{position:relative;display:inline-block;width:70%;height:100%;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;justify-content:center;-webkit-box-align:center;-webkit-align-items:center;align-items:center}#searchList .search .search-box label{height:.32rem;line-height:.34rem;font-size:.14rem;color:#dedede;position:absolute;top:.08rem;left:22%}#searchList .search .search-box label span{font-size:.13rem}#searchList .search .search-box label:before{margin-right:.05rem}#searchList .search .search-box input{width:100%;height:.32rem;line-height:.24rem;font-size:.12rem;color:#666;border-radius:.2rem;text-indent:5%}#searchList .searchList-type{position:relative;z-index:9999;display:-webkit-box;display:-webkit-flex;display:flex;height:.4rem;line-height:.4rem;font-size:.14rem;color:#666;background-color:#fff}#searchList .searchList-type tab-item{-webkit-box-flex:1;-webkit-flex:1;flex:1;box-flex:1;min-width:0;text-align:center}#searchList .searchList-hot{width:90%;height:auto;margin:0 auto;margin-top:.1rem}#searchList .searchList-hot h1{font-size:.14rem;color:#666;font-weight:400}#searchList .searchList-hot .hot-contxt{padding-top:.15rem;width:100%;height:auto;display:-webkit-box;display:-webkit-flex;display:flex;-moz-flex-direction:row;-o-flex-direction:row;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;flex-direction:row;-o-flex-wrap:wrap;-webkit-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-pack:justify;-webkit-justify-content:space-between;justify-content:space-between}#searchList .searchList-hot .hot-contxt li{font-size:.14rem;color:#333;padding:.05rem .08rem;margin-bottom:.08rem;position:relative}#searchList .searchList-hot .hot-contxt li:after{content:\"  \";position:absolute;left:0;top:0;width:200%;height:200%;border:1px solid #cecece;border-radius:40px;-webkit-transform-origin:0 0;transform-origin:0 0;-webkit-transform:scale(.5);transform:scale(.5);box-sizing:border-box}#searchList .singleSong{width:100%;height:auto}#searchList .singleSong li{margin-left:5%;width:95%;height:.5rem;line-height:.5rem;padding:.03rem 0}#searchList .singleSong li p,#searchList .singleSong li span{width:100%;height:50%;line-height:.25rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}#searchList .singleSong li p{font-size:.14rem;color:#333}#searchList .singleSong li span{display:block;font-size:.12rem;color:#666}#searchList .albums,#searchList .playlists,#searchList .singer,#searchList .userprofiles{width:100%;height:auto}#searchList .albums li,#searchList .playlists li,#searchList .singer li,#searchList .userprofiles li{width:100%;height:.5rem;line-height:.5rem;display:-webkit-box;display:-webkit-flex;display:flex}#searchList .albums li div,#searchList .playlists li div,#searchList .singer li div,#searchList .userprofiles li div{-webkit-box-flex:1 0 15%;-webkit-flex:1 0 15%;flex:1 0 15%;box-flex:1 0 15%;min-width:0;box-sizing:border-box;padding:.02rem .04rem}#searchList .albums li div img,#searchList .playlists li div img,#searchList .singer li div img,#searchList .userprofiles li div img{display:block;width:100%;height:100%}#searchList .albums li span,#searchList .playlists li span,#searchList .singer li span,#searchList .userprofiles li span{padding:.02rem 0;-webkit-box-flex:1 0 85%;-webkit-flex:1 0 85%;flex:1 0 85%;box-flex:1 0 85%;min-width:0;font-size:.14rem;color:#333}#searchList .albums span.halfBorder p,#searchList .albums span.halfBorder span,#searchList .playlists span.halfBorder p,#searchList .playlists span.halfBorder span,#searchList .userprofiles span.halfBorder p,#searchList .userprofiles span.halfBorder span{width:100%;height:50%;line-height:.25rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}#searchList .albums span.halfBorder p,#searchList .playlists span.halfBorder p,#searchList .userprofiles span.halfBorder p{font-size:.14rem;color:#333}#searchList .albums span.halfBorder span,#searchList .playlists span.halfBorder span,#searchList .userprofiles span.halfBorder span{display:block;font-size:.12rem;color:#666}#searchList .userprofiles img{border-radius:50%}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(148)("b51c7712", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "search-box"
  }, [(_vm.SearchLabel == true) ? _c('label', {
    staticClass: "iconfont icon-glass",
    attrs: {
      "for": "searchBoxs"
    }
  }, [_c('span', [_vm._v("搜索音乐,歌词,电台")])]) : _vm._e(), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.searchVal),
  ...
  }, [_vm._v("取消")])], 1), _vm._v(" "), _c('tab', {
    staticClass: "searchList-type",
    attrs: {
      "line-width": 2,
      "bar-active-color": "#f33",
      "active-color": "#f33"
    ...
    attrs: {
      "selected": _vm.searchType == 1
    },
    on: {
      "on-item-click": _vm.switchSearchType
    }
  }, [_vm._v("单曲")]), _vm._v(" "), _c('tab-item', {
    attrs: {
      "selected": _vm.searchType == 100
    },
    on: {
      "on-item-click": _vm.switchSearchType
    }
  }, [_vm._v("歌手")]), _vm._v(" "), _c('tab-item', {
    attrs: {
      "selected": _vm.searchType == 10
    },
    on: {
      "on-item-click": _vm.switchSearchType
    }
  }, [_vm._v("专辑")]), _vm._v(" "), _c('tab-item', {
    attrs: {
      "selected": _vm.searchType == 1000
    },
    on: {
      "on-item-click": _vm.switchSearchType
    }
    ...
    attrs: {
      "selected": _vm.searchType == 1002
    },
    on: {
      "on-item-click": _vm.switchSearchType
    }
  }, [_vm._v("用户")])], 1), _vm._v(" "), (_vm.SearchLabel == true && _vm.searchList.length == 0) ? _c('div', {
    staticClass: "searchList-hot"
  }, [_c('h1', {
    staticClass: "hot-title"
  }, [_vm._v("热门搜索")]), _vm._v(" "), _c('ul', {
    staticClass: "hot-contxt"
  }, _vm._l((_vm.hotSearchKeywords), function(item, i) {
    return _c('li', {
      key: i,
      on: {
        "click": function($event) {
          _vm.chooseHotSearch(item)
        }
      }
    }, [_vm._v(_vm._s(item))])
  }))]) : _vm._e(), _vm._v(" "), (_vm.searchType == 1 && _vm.searchList != '') ? _c('div', {
    staticClass: "singleSong"
  }, [_c('ul', _vm._l((_vm.searchList.songs), function(item, i) {
    ...
    }, [_c('p', [_vm._v(_vm._s(item.name))]), _vm._v(" "), _c('span', [_vm._v(_vm._s(item.artists[0].name) + " - " + _vm._s(item.album.name))])])
  }))]) : _vm._e(), _vm._v(" "), (_vm.searchType == 100 && _vm.searchList != '') ? _c('div', {
    staticClass: "singer"
  }, [_c('ul', _vm._l((_vm.searchList.artists), function(item, i) {
    return _c('router-link', {
      key: i,
      attrs: {
        "tag": "li",
  ...
  }))]) : _vm._e(), _vm._v(" "), (_vm.searchType == 10 && _vm.searchList != '') ? _c('div', {
    staticClass: "albums"
  }, [_c('ul', _vm._l((_vm.searchList.albums), function(item, i) {
    return _c('router-link', {
      key: i,
      attrs: {
        "tag": "li",
      ...
      staticClass: "halfBorder"
    }, [_c('p', [_vm._v(_vm._s(item.name))]), _vm._v(" "), _c('span', [_vm._v(_vm._s(item.artists[0].name))])])])
  }))]) : _vm._e(), _vm._v(" "), (_vm.searchType == 1000 && _vm.searchList != '') ? _c('div', {
    staticClass: "playlists"
  }, [_c('ul', _vm._l((_vm.searchList.playlists), function(item, i) {
    return _c('router-link', {
      key: i,
      attrs: {
        "to": {
      ...
      staticClass: "halfBorder"
    }, [_c('p', [_vm._v(_vm._s(item.name))]), _vm._v(" "), _c('span', [_vm._v(_vm._s(item.trackCount) + "首音乐 by " + _vm._s(item.creator.nickname) + ", 播放" + _vm._s(_vm.format.formatPlayCount(item.playCount)) + "次")])])])
  }))]) : _vm._e(), _vm._v(" "), (_vm.searchType == 1002 && _vm.searchList != '') ? _c('div', {
    staticClass: "userprofiles"
  }, [_c('ul', _vm._l((_vm.searchList.userprofiles), function(item, i) {
    return _c('li', {
      key: i
    }, [_c('div', [_c('img', {
      directives: [{
        ...
        expression: "item.backgroundUrl"
      }]
    })]), _vm._v(" "), _c('span', {
      staticClass: "halfBorder"
    }, [_c('p', [_vm._v(_vm._s(item.nickname))]), _vm._v(" "), _c('span', [_vm._v(_vm._s(item.signature))])])])
  }))]) : _vm._e()], 1)
},staticRenderFns: []}
