...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    switchSongList: function switchSongList(type, index) {
      this.tabIndex = index;
...
// module
exports.push([module.i, ".backgroundRed{background-color:#f33}.mx_flex{display:-webkit-box;display:-webkit-flex;display:flex}.mx_flex_content{-moz-flex-direction:row;-o-flex-direction:row;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;flex-direction:row;-o-flex-wrap:wrap;-webkit-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-pack:justify;-webkit-justify-content:space-between;justify-content:space-between}.mx_flex_mid{display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;justify-content:center;-webkit-box-align:center;-webkit-align-items:center;align-items:center}.mx_brbox{box-sizing:border-box}.mx_more_ellipsis{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}.mx_more_ellipsis,.mx_single_ellipsis{overflow:hidden;text-overflow:ellipsis}.mx_single_ellipsis{white-space:nowrap}.halfBorder{position:relative}.halfBorder:after{content:\"  \";position:absolute;left:0;top:0;width:200%;height:200%;border-bottom:1px solid #dedede;-webkit-transform-origin:0 0;transform-origin:0 0;-webkit-transform:scale(.5);transform:scale(.5);box-sizing:border-box}#songList{width:100%;height:auto}#songList .titleWrapper{width:100%;height:.5rem}#songList .songListTitle{width:80%;height:.3rem;padding:.1rem 0;position:fixed;z-index:999;display:-webkit-box;display:-webkit-flex;display:flex;left:50%;-webkit-transform:translatex(-50%);transform:translatex(-50%)}#songList .songListTitle span{background-color:#fff;-webkit-box-flex:1;-webkit-flex:1;flex:1;box-flex:1;min-width:0;font-size:.14rem;color:#f33;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;justify-content:center;-webkit-box-align:center;-webkit-align-items:center;align-items:center;border:1px solid #f33}#songList .songListTitle span:first-child{border-right:0;border-radius:.5rem 0 0 .5rem}#songList .songListTitle span:nth-child(2){border-right:0}#songList .songListTitle span:nth-child(3){border-radius:0 .5rem .5rem 0}#songList .songListTitle .beHighLight{background-color:#f33;color:#fff}#songList .songListContxt{width:100%;height:auto}#songList .songListContxt ul{display:-webkit-box;display:-webkit-flex;display:flex;-moz-flex-direction:row;-o-flex-direction:row;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-webkit-flex-direction:row;flex-direction:row;-o-flex-wrap:wrap;-webkit-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-pack:justify;-webkit-justify-content:space-between;justify-content:space-between}#songList .songListContxt ul li{-webkit-box-flex:0 0 49%;-webkit-flex:0 0 49%;flex:0 0 49%;box-flex:0 0 49%;min-width:0;position:relative;padding-bottom:.1rem;overflow:hidden}#songList .songListContxt ul li img{display:block;width:100%}#songList .songListContxt ul li p{overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;height:.3rem;line-height:.16rem;padding:.05rem .06rem 0;font-size:.12rem;color:#666}#songList .songListContxt ul li i{position:absolute;top:.03rem;right:.05rem;font-size:.12rem;color:#fff}", ""]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(148)("164e9597", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "titleWrapper"
  }, [_c('div', {
    staticClass: "songListTitle"
  }, [_c('span', {
    class: {
      beHighLight: _vm.tabIndex == 0
    },
    on: {
      "click": function($event) {
        _vm.switchSongList('new', 0)
      }
    }
  }, [_vm._v("最新")]), _vm._v(" "), _c('span', {
    class: {
      beHighLight: _vm.tabIndex == 1
    },
    on: {
      "click": function($event) {
        _vm.switchSongList('hot', 1)
      }
    }
  }, [_vm._v("最热")]), _vm._v(" "), _c('span', {
    class: {
      beHighLight: _vm.tabIndex == 2
    },
    on: {
      "click": function($event) {
        _vm.switchSongList('Boutique', 2)
      }
    }
  }, [_vm._v("精品")])])]), _vm._v(" "), _c('div', {
    ...
    }), _vm._v(" "), _c('p', [_vm._v(_vm._s(item.name) + " - " + _vm._s(item.creator.nickname))])])
  }))])], 1)
},staticRenderFns: []}
